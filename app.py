...
def registrarUsuario():
    ...
    mensajes="Su codigo de activacion es"+codigo2;
    envioemail.enviar(correo,asunto,mensajes)
...
def enviarEE():
    ...
    mensaje2="Usted recibio un nuevo mensaje por favor ingresar a la plataforma para obsevarlo."
...
def ActualizarPa():
    ...
    controlador.actualzarpassw(password2,origen)
